export const ENTITIES = {
    ...
    climate: {
        ...
        swingModes: ["off", "on"],
        sleepEntity: "sensor.sleep_mode_climatisation",
    },
    heating: {
        rooms: [
        ...
        rooms: [
            {
                ...
                colorPresets: [
                    ...
                    { label: "Rouge", color: "#ef4444", rgb: [255, 50, 50] },
                    { label: "Vert", color: "#22c55e", rgb: [50, 255, 100] },
                    { label: "Bleu", color: "#3b82f6", rgb: [50, 100, 255] },
                ],
            },
            {
